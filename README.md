...
-----------     ----                                               -------    ------                                                                                                                                                                             
Function        Close-WmsApiSession                                1.0.1      PSWMS                                                                                                                                                                              
Function        Get-WmsDeviceDetails                               1.0.1      PSWMS                                                                                                                                                                              
Function        Get-WmsDeviceInventoryDetails                      1.0.1      PSWMS                                                                                                                                                                              
Function        Get-WmsGroupInventoryDetails                       1.0.1      PSWMS                                                                                                                                                                              
Function        Get-WmsInstalledApps                               1.0.1      PSWMS                                                                                                                                                                              
Function        Get-WmsLogfileDevice                               1.0.1      PSWMS                                                                                                                                                                              
Function        New-WmsApiSession                                  1.0.1      PSWMS                                                                                                                                                                              
Function        Send-WmsBulkMessage                                1.0.1      PSWMS                                                                                                                                                                              
Function        Send-WmsMessage                                    1.0.1      PSWMS                                                                                                                                                                              
Function        Send-WmsQueryDevice                                1.0.1      PSWMS                                                                                                                                                                              
Function        WmsRestartDevice                                   1.0.1      PSWMS                                                                                                                                                                              
Function        WmsShutdownDevice                                  1.0.1      PSWMS                                                                                                                                                                              
Function        WmsUnregisterDevice                                1.0.1      PSWMS                                                                                                                                                                              
```
